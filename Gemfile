...
gem 'kramdown', '~> 1.5.0' # Kramdown works on all platforms, rdiscount only on mri
gem 'htmlcompressor', '~> 0.1.2' # Adds in HTML minification, helps remove the warning on awestruct startup
